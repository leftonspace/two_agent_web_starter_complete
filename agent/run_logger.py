...
2. Dataclass-based API (for structured logging)
...
class IterationLog:
    ...
    role: str  # "manager", "supervisor", "employee", "system"
...
class RunSummary:
    ...
    estimated_cost_usd: Optional[float] = None  # Pre-run cost estimate
...
def log_iteration(
    ...
    Args:
        ...
        role: "manager", "supervisor", "employee", "system"
...
# ══════════════════════════════════════════════════════════════════════
# Session-level Structured API (Auto-Pilot)
# ══════════════════════════════════════════════════════════════════════
...
def log_session_run(
    ...
    session.total_cost_usd += float(run_entry["cost_usd"])
