...
# Some modules import these shorter names; keep them in sync.
...
# Backwards-compatible alias expected by run_mode/auto_pilot
SESSION_COMPLETED = SESSION_SUCCESS
